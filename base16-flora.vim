" Base16 Flora (https://github.com/chriskempson/base16)
" Scheme: Avery Glitch, based on floraverse (http://floraverse.com)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-flora.".&background.".sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-flora"
